    ...
    publications {
        create<MavenPublication>("publication") {
            ...
            pom {
                ...
                url.set("https://github.com/Kotatsu-RTM/FastSet")
                ...
                scm {
                    connection.set("scm:git:git://github.com/Kotatsu-RTM/FastSet.git")
                    developerConnection.set("scm:git:ssh://github.com/Kotatsu-RTM/FastSet.git")
                    url.set("https://github.com/Kotatsu-RTM/FastSet")
                }
            }
        }
